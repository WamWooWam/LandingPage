...
export default function TileSquare310x310BlockAndText02(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-block-and-text02" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
            ...
            <div className="headlines">
                <TileTextBinding className="tile-headline-style id-2" binding={text2} />
