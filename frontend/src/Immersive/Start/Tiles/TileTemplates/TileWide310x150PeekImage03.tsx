...
import "./tile-wide310x150-peek-image03.scss"
...
export default function TileWide310x150PeekImage03(props: TileTemplateProps) {
    const image1 = props.elements.find(b => b.id === 1 && b.type === 'image');
    const text1 = props.elements.find(b => b.id === 1 && b.type === 'text');
    
    return (
        <TileNotificationBinding className="tile-wide310x150-peek-image03" forceBadgePlate={false} x={0} y={0} width={248} height={240}>
