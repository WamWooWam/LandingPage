...
import "./tile-square310x310-small-images-and-text-list05.scss"
...
export default function TileSquare310x310SmallImagesAndTextList05(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-small-images-and-text-list05" x={0} y={0} width={248} height={248}>
