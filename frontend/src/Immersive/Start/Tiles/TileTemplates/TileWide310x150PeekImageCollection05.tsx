...
import "./tile-wide310x150-peek-image-collection05.scss"
...
export default function TileWide310x150PeekImageCollection05(props: TileTemplateProps) {
    ...
    return (
        <div className="tile-wide310x150-peek-image-collection05">
