...
import "./tile-square310x310-image-and-text02.scss"
...
export default function TileSquare310x310ImageAndText02(props: TileTemplateProps) {
    ...
    return (
        <div className="tile-square310x310-image-and-text02">
