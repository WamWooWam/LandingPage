...
export default function TileSquare310x310ImageCollectionAndText01(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-image-collection-and-text01" forceBadgePlate={true} dynamicFormat={false} singleLineYOffset="8px" x={0} y={0} width={248} height={248}>
