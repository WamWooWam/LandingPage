...
export default function TileSquare310x310SmallImagesAndTextList01(
    ...
    return (
        <TileNotificationBinding
            className="tile-square310x310-small-images-and-text-list01"
            ...
            <div className="headlines">
                ...
                />
                <TileTextBinding
                    className="tile-headline-style id-4"
                    binding={text4}
                />
                <TileTextBinding
                    className="tile-headline-style id-7"
                    binding={text7}
                />
            </div>
