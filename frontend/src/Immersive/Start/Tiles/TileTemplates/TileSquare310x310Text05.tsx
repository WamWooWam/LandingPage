...
export default function TileSquare310x310Text05(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-text05" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
