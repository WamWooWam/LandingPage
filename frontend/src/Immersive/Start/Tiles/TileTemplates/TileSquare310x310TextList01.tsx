...
import './tile-square310x310-text-list01.scss';
...
export default function TileSquare310x310TextList01(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding
            className="tile-square310x310-text-list01"
