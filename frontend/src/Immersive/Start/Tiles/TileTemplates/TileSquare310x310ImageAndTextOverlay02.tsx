...
import "./tile-square310x310-image-and-text-overlay02.scss"
...
export default function TileSquare310x310ImageAndTextOverlay02(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-image-and-text-overlay02" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
            ...
            <div className="text-fields">
                <TileTextBinding className="tile-body-text-style id-2" isBottomUp={true} binding={text2} />
            </div>
