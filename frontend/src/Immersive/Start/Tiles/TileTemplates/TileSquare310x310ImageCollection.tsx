...
export default function TileSquare310x310ImageCollection(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-image-collection" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
