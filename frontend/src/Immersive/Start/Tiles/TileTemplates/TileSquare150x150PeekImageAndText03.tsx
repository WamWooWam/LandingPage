...
export default function TileSquare150x150PeekImageAndText03(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square150x150-peek-image-and-text03" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={120} height={240}>
