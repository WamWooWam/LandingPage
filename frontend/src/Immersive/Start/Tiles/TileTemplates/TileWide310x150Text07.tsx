...
import "./tile-wide310x150-text07.scss"
...
export default function TileWide310x150Text07(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-wide310x150-text07" forceBadgePlate={false} x={0} y={0} width={248} height={120}>
