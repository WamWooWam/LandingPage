...
import "./tile-wide310x150-peek-image-collection03.scss"
...
export default function TileWide310x150PeekImageCollection03(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-wide310x150-peek-image-collection03" forceBadgePlate={false} x={0} y={0} width={248} height={240}>
