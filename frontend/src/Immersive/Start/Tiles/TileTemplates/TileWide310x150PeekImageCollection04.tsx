...
import "./tile-wide310x150-peek-image-collection04.scss"
...
export default function TileWide310x150PeekImageCollection04(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-wide310x150-peek-image-collection04" forceBadgePlate={false} x={0} y={0} width={248} height={240}>
