...
import "./tile-square310x310-image-and-text01.scss"
...
export default function TileSquare310x310ImageAndText01(props: TileTemplateProps) {
    const image1 = props.elements.find(b => b.id === 1 && b.type === 'image');
    const text1 = props.elements.find(b => b.id === 1 && b.type === 'text');
    
    return (
        <TileNotificationBinding className="tile-square310x310-image-and-text01" forceBadgePlate={true} dynamicFormat={false} logoMargins={{left: 48, top: 208, right: 232, bottom: 244}} badgeMargins={{left: 16, top: 208, right: 212, bottom: 244}} logoAndBadgeMargins={{left: 48, top: 208, right: 212, bottom: 244}} singleLineYOffset="8px">
