...
import "./tile-square310x310-block-and-text01.scss"
...
export default function TileSquare310x310BlockAndText01(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-block-and-text01" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
            ...
            <div className="block-text-fields">
                <TileTextBinding className="tile-block-text-style id-8" binding={text8} />
            </div>
