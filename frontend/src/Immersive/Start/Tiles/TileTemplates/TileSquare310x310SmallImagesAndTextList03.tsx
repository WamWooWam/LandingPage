...
import "./tile-square310x310-small-images-and-text-list03.scss"
...
export default function TileSquare310x310SmallImagesAndTextList03(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-small-images-and-text-list03" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
