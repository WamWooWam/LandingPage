...
function getEmmaTile(req: Request, res: Response) {
    ...
    const content1 = createBindingFromTemplate(
        root,
        visual1,
    ...
    imageElement.setAttribute(
        'src',
        '/api/media/normal/Friends_zfgz6xjnaz0ym/emma2/square150x150logo',
    );

    const visual2 = createVisual(root);
    visual2.setAttribute('branding', 'name');

    const content2 = createBindingFromTemplate(
        root,
        visual2,
        TileTemplateType.tileSquare150x150Image,
    );
    ...
    imageElement.setAttribute(
        'src',
        '/api/media/normal/Friends_zfgz6xjnaz0ym/emma/square150x150logo',
    );
