...
module.exports = [
    {
        ...
        module: {
            rules: [
                ...
                },
                {
                    ...
                    use: [
                        { loader: 'file-loader', options: { outputPath: 'static/' } },
                        '@landing-page/xml-loader'
                    ]
                },
                {
                    test: /StartScreen\.xml$/i,
                    use: ['raw-loader', '@landing-page/xml-loader']
                },
            ],
        },
        optimization: {
        ...
        plugins: [
            ...
            new InlineChunkHtmlPlugin(HtmlWebpackPlugin, [/(runtime|index)/]),
            new HTMLInlineCSSWebpackPlugin({filter: (n) => /(index)/.test(n)}),
