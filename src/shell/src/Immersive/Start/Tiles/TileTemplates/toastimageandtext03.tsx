...
import "./toastimageandtext03.scss"
...
export default function toastimageandtext03(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="toastimageandtext03" dynamicFormat={false} x={0} y={0} width={308} height={72}>
