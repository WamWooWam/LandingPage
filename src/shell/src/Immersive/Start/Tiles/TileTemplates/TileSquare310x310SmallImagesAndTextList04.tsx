...
export default function TileSquare310x310SmallImagesAndTextList04(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-square310x310-small-images-and-text-list04" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={248}>
