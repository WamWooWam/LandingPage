...
export default function toasttext03(props: TileTemplateProps) {
    const text1 = props.elements.find(b => b.id === 1 && b.type === 'text');
    const text2 = props.elements.find(b => b.id === 2 && b.type === 'text');
    
    return (
        <TileNotificationBinding className="toasttext03" dynamicFormat={false} x={0} y={0} width={308} height={72}>
