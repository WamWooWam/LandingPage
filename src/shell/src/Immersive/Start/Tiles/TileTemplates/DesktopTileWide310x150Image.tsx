...
export default function DesktopTileWide310x150Image(props: TileTemplateProps) {
    const image1 = props.elements.find(b => b.id === 1 && b.type === 'image');
    
    return (
        <TileNotificationBinding className="desktop-tile-wide310x150-image" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={248} height={120}>
