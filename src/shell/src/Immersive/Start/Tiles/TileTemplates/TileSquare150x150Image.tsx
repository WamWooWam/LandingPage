...
import "./tile-square150x150-image.scss"
...
export default function TileSquare150x150Image(props: TileTemplateProps) {
    const image1 = props.elements.find(b => b.id === 1 && b.type === 'image');
    
    return (
        <TileNotificationBinding className="tile-square150x150-image" forceBadgePlate={true} dynamicFormat={false} x={0} y={0} width={120} height={120}>
