...
import "./tile-wide310x150-small-image-and-text04.scss"
...
export default function TileWide310x150SmallImageAndText04(props: TileTemplateProps) {
    ...
    return (
        <TileNotificationBinding className="tile-wide310x150-small-image-and-text04" forceBadgePlate={false} x={0} y={0} width={248} height={120}>
